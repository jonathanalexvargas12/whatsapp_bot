...
def procesar_mensaje(telefono, mensaje):
    ...
    # "repetir" reinicia la encuesta desde la primera pregunta
    ...
    # "encuesta" inicia un nuevo reporte desde cualquier estado
    if mensaje_lower == "encuesta":
        Sesion.guardar_estado(telefono, Estado.NOMBRE_APELLIDO, {})
        return get_mensaje_estado(Estado.NOMBRE_APELLIDO)
    
    # INICIO: no responde ningún otro mensaje
    if estado_actual == Estado.INICIO:
        return None
    
    # COMPLETADO: no responde ningún otro mensaje
